% vsearch-udbinfo(1) version 2.33.0 | vsearch manual
...
`--udbinfo` *udbfile*
: Read and inspect the UDB database *udbfile*. As UDB files cannot be read
  from pipes, *udbfile* must be a seekable file path (see
